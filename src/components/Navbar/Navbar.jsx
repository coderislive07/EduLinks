  ...
  export default function Navbar() {
    ...
    return (
      <nav className="w-full  bg-white shadow-md  pt-[-4vh] z-50 relative  top-0 xl:h-[65px] 2xl:px-[50px]">
        <div className="lg:max-w-[1600px]  mx-auto px-20 ">
          ...
          <div className="lg:hidden  ">
            ...
            <div className="hidden lg:flex items-center lg:w-[40vw] xl:w-[45vw] 2xl:w-[37vw]  lg:space-x-3">
            ...
            <div className="hidden lg:flex items-center space-x-2 xl:space-x-4">
              <button className=" py-1.5 lg:p-[4px] xl:py-1.5 xl:p-[0] lg:w-[13vw]  xl:w-[10vw]  text-black border font-roboto1 font-bold   border-black rounded-lg hover:bg-[#37d7d9] hover:text-black transition-colors text-base  xl:text-[13px]">
              ...
              <button className="px-3 flex py-1.5  xl:w-[13vw]  text-black border font-roboto1 font-bold   border-black rounded-lg hover:bg-[#37d7d9] hover:text-black transition-colors text-base xl:text-[12px] 2xl:text-[13px] ">
                <svg className="w-3 h-3 lg:mt-[5.8px] xl:mt-1 xl:w-4 xl:h-4 mr-1 xl:mr-2" viewBox="0 0 576 512">
                  <path
                    fill="currentColor"
