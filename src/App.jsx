  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/australia-topuniversity/:id" element={<UniversityOfAus />} />
        <Route path="/canada-topuniversity" element={<Canada />} />
        <Route path="/canada-topuniversity/:id" element={<Universityofcanada />} />
        ...
        <Route path="/services/student-visa" element={<Studyvisa />} />
        <Route path="/services/scholarship-assesment" element={<Scholarship />} />
        <Route path="/services/Loan-Guidance" element={<Loan />} />
        <Route path="/services/post-landing" element={<PostLanding />} />
        <Route path="/services/edulinkAi" element={<Edulink />} />
        <Route path="/services/career-guidance" element={<CareeGuide />} />


        <Route path="/study-destination/usa" element={<USA1 />} />
        <Route path="/study-destination/canada" element={<Canada2 />} />
        <Route path="/study-destination/australia" element={<Australia3 />} />
        <Route path="/study-destination/newzealand" element={<NewZealand4 />} />
        <Route path="/study-destination/uk" element={<UK5 />} />
        <Route path="/study-destination/germany" element={<Germany6 />} />
