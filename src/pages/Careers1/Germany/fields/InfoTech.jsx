...
const courses = [
    {
      ...
      description:
        "Cybersecurity is a top priority in Germany, with specialists tasked with protecting the country's digital infrastructure from an increasing number of cyber threats. Cybersecurity professionals work across sectors like government, finance, and healthcare to safeguard data and systems. As cybercrime continues to rise, cybersecurity specialists are in high demand in Germany.",
    },
    {
      title: "Machine Learning Engineer",
      image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-YtlZ6jQvEjrdrQRjplNN6ei1XEnkGh.png",
      description:
        "Machine Learning Engineers in Germany are at the forefront of AI innovations, building algorithms that enable machines to learn from data. These engineers work across sectors such as healthcare, finance, and agriculture, contributing to automation and decision-making processes. Germany's growing AI research ecosystem provides numerous opportunities for machine learning professionals.",
    },
    {
      title: "Blockchain Developer",
      image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-rZJHSSEcVm3ZVGFj31ImgoAvrK8DCG.png",
      description:
        "Blockchain Developers in Germany are transforming industries by implementing decentralized systems that enhance transparency and security. From finance to agriculture, blockchain technology is gaining traction, and developers are playing a key role in its adoption. With Germany's focus on digital transformation, blockchain developers are in high demand.",
    }
  ];
...
const faqs = [
  ...
  {
    question: "What skills are essential for IT professionals in Germany?",
    answer:
      "Technical expertise, adaptability to new technologies, and problem-solving skills are essential.",
  },
  {
    question: "Are there internships available for IT students in Germany?",
    answer:
      "Yes, many Germanyn universities and companies offer internships, providing practical experience in various IT fields.",
  },
  {
    question: "What are the emerging technologies in Germany’s IT sector?",
    answer:
      "AI, blockchain, and cybersecurity are among the most prominent emerging technologies.",
  },
  {
    question: "Can Germanyn IT professionals work internationally?",
    answer:
      "Yes, Germanyn IT qualifications are globally respected, enabling professionals to pursue international careers.",
  },
  {
    question: "What is the job outlook for IT professionals in Germany?",
    answer:
      "The outlook is highly positive, especially in cybersecurity, AI, and blockchain development.",
  },
  {
    question: "How does specialization affect my career in Germanyn IT?",
    answer:
  ...
  {
    question: "Are IT jobs flexible in Germany?",
    answer:
      "Many IT roles offer flexible working arrangements, including remote work and freelance opportunities.",
  },
  {
    question: "What are the challenges faced by IT professionals in Germany today?",
    answer:
      ...
      <div>
        <div className="absolute  left-[6%] top-[62%]">
          ...
          <div className="max-w-[1180px] mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            Germany’s Information Technology sector is rapidly expanding, playing a critical role in economic growth and innovation. IT professionals in Germany work on cutting-edge technologies in cybersecurity, AI, and blockchain, contributing to advancements in industries such as finance, healthcare, and agriculture. With Sydney and Melbourne emerging as key tech hubs, Germany offers a dynamic environment for IT professionals.
            </h1>
          </div>
...
<div className="bg-white py-16">
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
    ...
    <div className="text-center">
      ...
      Choosing a career in IT in Germany provides the opportunity to work in a thriving industry that drives innovation and digital transformation. IT professionals play a crucial role in addressing global challenges, from cybersecurity to AI-driven automation, making it a dynamic and impactful career path.
      </p>
    </div>
    ...
    <div className="text-center">
      ...
      <p className="text-[24px] font-roboto1 text-[#232323] leading-[37.2px]">
      The job outlook for IT professionals in Germany is highly favorable, particularly in cybersecurity, AI, and blockchain. As industries continue to adopt digital solutions, the demand for skilled IT professionals is expected to rise significantly.
      </p>
    </div>
    ...
    <div className="text-center">
      ...
      <p className="text-[24px] font-roboto1 text-[#232323] leading-[37.2px]">
      The future of IT in Germany will be centered around AI, cybersecurity, and blockchain technology. Machine learning engineers will drive AI advancements, cybersecurity specialists will protect Germany’s digital infrastructure, and blockchain developers will expand decentralized systems across industries.
      </p>
    </div>
    ...
    <div className="text-center">
      ...
      <p className="text-[24px] font-roboto1 text-[#232323] leading-[37.2px]">
      Leading employers in Germany’s IT sector include Atlassian, Telstra, NAB, and government agencies. Sydney and Melbourne are key hubs for tech innovation, with numerous startups and multinational companies seeking IT professionals.
      </p>
    </div>
  </div>
</div>
