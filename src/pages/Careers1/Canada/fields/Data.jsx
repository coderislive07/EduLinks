    ...
    <div className="text-center">
      ...
      <div>
        <div className="text-center max-w-[1180px] mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <p className="text-[24px] font-roboto1 text-[#232323] leading-[37.2px]">
          Salaries for data science professionals in Canada are highly competitive. Data analysts typically earn around AUD $90,000 annually, while data engineers can make about AUD $110,000. Business intelligence analysts earn approximately AUD $95,000, depending on experience and industry.
          </p>
        </div>
      </div>
