...
const courses = [
  ...
  },
  {
    ...
    description:
      "Public Health Administration in USA focuses on improving community health through disease prevention, policy development, and health promotion. Public health professionals work with government agencies, including the Department of Health, to address public health challenges such as obesity, mental health, and indigenous health.",
  },
  {
    title: 
"Clinical Technology",
    ...
    description:
      "Clinical Technology is a fast-growing sector in USA, with advancements in telehealth, AI diagnostics, and medical imaging technologies. Clinical technologists collaborate with healthcare providers to ensure the effective use of these technologies in improving patient care and health outcomes.",
  }
]
...
const faqs = [
  ...
  {
    question: "What skills are essential for health science professionals in USA?",
    answer:
      "Analytical skills, technical expertise, and the ability to work collaboratively are critical.",
  },
  {
    question: "Are there internships available for health science students in USA?",
    answer:
      "Yes, internships and placements are widely available at hospitals, research institutions, and government agencies.",
  },
  {
    question: "What are the emerging technologies in USA’s health science sector?",
    answer:
      "Emerging technologies include telemedicine, AI in diagnostics, and wearable health devices.",
  },
  {
    question: "Can USAn health science professionals work internationally?",
    answer:
      "Yes, USAn health qualifications are respected globally, allowing professionals to pursue international careers.",
  },
  {
    question: "What is the job outlook for health science professionals in USA?",
    answer:
      "The job outlook is strong, particularly in medical research, public health, and clinical technology.",
  },
  {
    question: "How does specialization affect my career in USAn health sciences?",
    answer:
  ...
  {
    question: "Are health science jobs flexible in USA?",
    answer:
      "Yes, many roles offer flexible working arrangements, including remote work and part-time options.",
  },
  {
    question: "What are the challenges faced by health science professionals in USA today?",
    answer:
      ...
      <div>
        <div className="absolute  left-[6%] top-[62%]">
          ...
          <div className="max-w-[1180px] mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            Health Sciences in USA is a thriving and multidisciplinary field that integrates medical research, public health administration, and clinical technology to advance healthcare solutions. USAn professionals contribute significantly to global health through cutting-edge research, policy development, and the application of new technologies. With a well-established healthcare system and a focus on public health, USA offers excellent opportunities for career growth in health sciences.
            </h1>
          </div>
