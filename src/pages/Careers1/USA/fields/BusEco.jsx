    ...
    <div className="text-center">
      ...
      <div>
        <div className="text-center max-w-[1180px] mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <p className="text-[24px] font-roboto1 text-[#232323] leading-[37.2px]">
          Business & Economics professionals in USA earn competitive salaries. Financial analysts typically earn around USD $85,000 annually, while economic data analysts make approximately USD $80,000. Supply chain managers can expect to earn about USD $95,000, depending on experience and expertise.
          </p>
        </div>
      </div>
