    ...
    <div className="text-center">
      ...
      <div>
        <div className="text-center max-w-[1180px] mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <p className="text-[24px] font-roboto1 text-[#232323] leading-[37.2px]">
          Salaries for marketing professionals in USA vary depending on the role. Digital marketing specialists typically earn around US $80,000 annually, while market research analysts make approximately US $85,000. SEO/SEM specialists can expect to earn about USD $75,000, depending on their experience and campaign complexity.
          </p>
        </div>
      </div>
