    ...
    <div className="text-center">
      ...
      <div>
        <div className="text-center max-w-[1180px] mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          Genetic counselors typically earn around NZD $80,000 annually,
           while pharmaceutical research technicians make approximately NZD $60,000. Bioinformatics specialists can expect salaries of about NZD $85,000, depending on their expertise and experience.
          </p>
        </div>
      </div>
