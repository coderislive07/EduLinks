    ...
    <div className="text-center">
      ...
      <div>
        <div className="text-center max-w-[1180px] mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <p className="text-[24px] font-roboto1 text-[#232323] leading-[37.2px]">
          Health science professionals in New Zealand enjoy competitive salaries. Medical researchers typically earn around NZD $85,000 annually, while public health administrators make approximately NZD $90,000. Clinical technologists can expect salaries near NZD $75,000, depending on experience and specialization.
          </p>
        </div>
      </div>
