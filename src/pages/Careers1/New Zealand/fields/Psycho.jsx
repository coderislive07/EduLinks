...
const faqs = [
  ...
  {
    question: "What degrees do I need to work in Psychology & Neuroscience in New Zealand?",
    answer:
  ...
  {
    question: "What skills are essential for psychology and neuroscience professionals in New Zealand?",
    answer:
  ...
  {
    question: "Are there internships available for psychology and neuroscience students in New Zealand?",
    answer:
  ...
  {
    question: "What are the emerging trends in New Zealand’s psychology and neuroscience sector?",
    answer:
      "AI in cognitive science, mental health app development, and advancements in neurorehabilitation are key trends.",
  },
  {
    question: "Can New Zealandn psychology and neuroscience professionals work internationally?",
    answer:
      "Yes, New Zealandn qualifications in psychology and neuroscience are globally respected, allowing professionals to work in various countries.",
  },
  {
    question: "What is the job outlook for psychology and neuroscience professionals in New Zealand?",
    answer:
      "The outlook is positive, especially in clinical neuropsychology, organizational psychology, and cognitive science research.",
  },
  {
    question: "How does specialization affect my career in New Zealandn psychology and neuroscience?",
    answer:
  ...
  {
    question: "Are psychology and neuroscience jobs flexible in New Zealand?",
    answer:
      "Yes, many roles offer flexibility, including opportunities for private practice, remote research, and consulting.",
  },
  {
    question: "What are the challenges faced by psychology and neuroscience professionals in New Zealand today?",
    answer:
...
New Zealand is known for its excellence in mental health services, workplace psychology, and cognitive science research, making it an ideal destination for professionals in psychology and neuroscience. With a focus on improving mental health outcomes, enhancing workplace productivity, and advancing cognitive research, New Zealand offers numerous career opportunities in fields like Industrial-Organizational Psychology, Neuropsychology, and Cognitive Science.   
            </h1>
          </div>
...
<div className="bg-white py-16">
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
    ...
    <div className="text-center">
      ...
      A career in psychology and neuroscience in New Zealand offers the opportunity to make a positive impact on mental health, organizational behavior, and cognitive research. Professionals in these fields contribute to improving patient care, workplace environments, and understanding of the brain, providing a meaningful and rewarding career path.
      </p>
    </div>
...
Top employers in New Zealand include health care organizations like the Royal Melbourne Hospital, research institutions such as the New Zealandn National University (ANU), and technology companies developing cognitive computing solutions. The New Zealandn government also supports mental health services and cognitive research, providing numerous opportunities for professionals in the field.
      </p>
    </div>
  </div>
</div>
      ...
      <div>
        <div className="text-center max-w-[1180px] mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <p className="text-[24px] font-roboto1 text-[#232323] leading-[37.2px]">
          Salaries for psychology and neuroscience professionals in New Zealand vary by role. Industrial-organizational psychologists typically earn around NZD $95,000 annually, while neuropsychologists make approximately NZD $100,000. Research scientists in cognitive science can expect to earn about NZD $90,000, depending on their experience and research area.
          </p>
        </div>
      </div>
