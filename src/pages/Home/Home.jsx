        ...
        <div className="max-w-[1400px] mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-8 pt-10 items-center">
            <div className="text-white space-y-6">
              ...
              <p className="text-lg font-roboto font-extrabold md:text-xl opacity-90 max-w-xl">
                Our Ai-enabled solutions help International Students to choose the best global universities.
              </p>
              <button className="bg-white  text-black font-roboto font-extrabold px-8 py-3 rounded-md cursor-pointer hover:bg-opacity-90 transition-all">
                Try Now
              </button>
            </div>
            <div>
